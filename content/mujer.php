...
if($_GET["subcategoria"] == "mujer_abrigos"){
    print <<< END
        <div id="sub-category">
            <div id="t-shirt-text">
                <p id="catText">Abrigos de mujer</p>
            </div>
        </div>
    END;
    ...
    print <<< END
        <div id="sub-category">
            <div id="t-shirt-text">
                <p id="catText">Faldas de mujer</p>
            </div>
        </div>
    END;
    ...
    print <<< END
        <div id="sub-category">
            <div id="t-shirt-text">
                <p id="catText">Remeras de mujer</p>
            </div>
        </div>
    END;
    ...
    print <<< END
        <div id="sub-category">
            <div id="t-shirt-text">
                <p id="catText">Vestidos de mujer</p>
            </div>
        </div>
    END;
